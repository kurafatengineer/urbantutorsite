...
/************************************************************
 * FILTER OPTIONS  (built from whatever the data contains)
 ************************************************************/

function populateFilterOptions() {

  fillSelect("subjectFilter", uniqueValues("subject"));
  fillSelect("boardFilter", uniqueValues("board"));
  fillSelect("cityFilter", uniqueValues("city"));
  fillSelect("mediumFilter", uniqueValues("medium"));
...
["subjectFilter", "boardFilter", "cityFilter", "mediumFilter", "sortTuitions"]
  .forEach(id => $(id)?.addEventListener("change", render));

$("clearFilters")?.addEventListener("click", () => {

  ["subjectFilter", "boardFilter", "cityFilter", "mediumFilter"]
    .forEach(id => { $(id).value = ""; });
...
async function applyForTuition(demoId, button) {
  ...
  try {
    ...
    // Remove it from the open list shortly after, since it's
