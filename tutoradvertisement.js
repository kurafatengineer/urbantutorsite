 ...
 *   - Middle layer: Class, Medium, Preferred Tutor, City & PIN Code
...
// "Kolkata - 700091" / just the city / just the PIN.
function formatCityPin(city, pin) {
...
function renderTuitionCard(item) {
  ...
  const details = [
    ...
    [ICONS.pin, "City & PIN Code", formatCityPin(item.city, item.pinCode)]
