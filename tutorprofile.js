...
function renderProfile(profile) {
  ...
  $("profileStats").innerHTML = [
    stat(profile.experience ? `${profile.experience} yrs` : "—", "Experience", "green"),
...
function renderClassCard(item) {
  ...
  return `
    <div class="class-card">
      <div class="class-spine" style="background: var(--${visual.accent}-dim, var(--surface-2)); color: var(--${visual.accent}, var(--muted));">
      ...
      <div class="class-body">
        <div class="class-card-top">
          <div class="class-card-top-left">
            <div class="class-subject-icon" style="background: var(--${visual.accent}-dim, var(--surface-2)); color: var(--${visual.accent}, var(--muted));">
              ${ICONS[visual.icon] || ICONS.cap}
            </div>
            <div class="class-subject-text">
        ...
        ${chips.length ? `
          <div class="class-timing">
            <div class="class-timing-label">${ICONS.clock} Preferred Timing</div>
...
/************************************************************
 * EDIT PROFILE  (UI stub — wire up once a backend action
 * for editing an existing tutor profile exists)
 ************************************************************/
