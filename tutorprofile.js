...
// The subject pill always uses this one fixed accent, whatever
// the subject is — this is intentional (see tutorprofile.js
// change log): a colour keyed to the subject text used to
    ...
    <div class="class-card">
      ...
      <div class="class-body">
        ...
        <div class="class-row-top">
          <span class="status-badge subject-badge" style="background: var(--${SUBJECT_ACCENT}-dim, var(--surface-2)); color: var(--${SUBJECT_ACCENT}, var(--muted)); border-color: var(--${SUBJECT_ACCENT}-line, var(--border-light));">${escapeHTML(item.subject || "Subject")}</span>
